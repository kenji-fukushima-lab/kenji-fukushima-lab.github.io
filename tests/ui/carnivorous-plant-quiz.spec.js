...
const pathname = "/ja/carnivorous-plant-quiz/";
...
const failurePath = "/carnivorous-plant-quiz/";
test(`quiz identifies an incomplete run after photo loading fails at ${failurePath}`, async ({ page }) => {
  ...
  await expect(page.locator("[data-cp-status]")).toContainText("stopped");
