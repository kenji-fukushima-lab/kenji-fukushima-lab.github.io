...
name: Seiu Yamazaki
name_native: 山﨑 聖翔 (やまざき せいう)
position_key: phd
show_in_people: true # Set true if you want this profile listed on the People page
image: people/seiu_yamazaki.jpg # Your profile picture in /assets/images/people/
content: # Leave it blank
image_circular: false # Do not change this
more_info: # Leave it blank
email: seiu.yamazaki@nig.ac.jp
